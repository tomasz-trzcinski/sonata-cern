...
class Classifier:
	def __init__(self):
		...
		self.ignore_list = [u'cov0', u'cov1', u'cov3', u'cov4', u'cov6', u'cov7', u'cov8', u'cov10', u'cov11', u'cov12', u'cov15', u'cov16']
		self.signal_label = 'PDGCode'
		self.min_max_scaler = preprocessing.MinMaxScaler()
		self.min_improve = 0.0005

	def set_estimators(self, n):
		self.clf = RandomForestClassifier(n_estimators=n, n_jobs=-1, random_state=11, oob_score=True)
		...
		for feature in tuned_features:
			for i in param_grid[feature]:
				...
				test_clf = RandomForestClassifier(n_estimators=current_grid['n_estimators'],
					max_features=current_grid['max_features'], max_depth=current_grid['max_depth'],
